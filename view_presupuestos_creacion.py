...
def render_creacion_presupuestos(rol_simulado):
    ...
    st.markdown("""
        <style>
            @page {
                size: letter;
                margin: 0in; /* Dejamos que el CSS controle los márgenes exactos */
            }
            
            @media print {
                /* 1. Evaporar por completo barras, menús, botones y componentes nativos */
                header, footer, 
                ...
                /* 2. Neutralizar el empaquetado estructural de Streamlit (Paddings asesinos) */
                ...
                /* 3. Forzar el Lienzo Absoluto a tamaño Carta Real (8.5 x 11 pulgadas) */
                .documento-hoja {
                    display: block !important;
                    ...
                    padding: 0.6in !important; /* Margen interno limpio del documento */
                    margin: 0px !important;
                ...
                /* Asegurar visibilidad de los hijos del presupuesto */
                .documento-hoja * {
            ...
            /* --- 🖥️ VISTA EN PANTALLA (Simulador de Hoja Carta en el Monitor) --- */
            .documento-hoja {
                font-family: 'Arial', sans-serif;
                color: #000000;
                background-color: #ffffff;
                width: 100%;
                max-width: 8.5in; /* Clava las proporciones porcentuales de las celdas */
                min-height: 11in;
    ...
    # ===================================================
        ...
        for idx_sec, sec in enumerate(secciones_activas):
            ...
            <table class="tabla-remastered">
                <thead>
                    <tr>
                        <th style="width: 8%; text-align: center;" {th_style}>ITEM</th>
                        <th style="width: 42%; text-align: left;" {th_style}>{sec_titulo}</th>
                        <th style="width: 20%; text-align: left;" {th_style}>MEDIDAS</th>
                        <th style="width: 10%; text-align: center;" {th_style}>JUEGOS/KITS</th>
                        <th style="width: 11%; text-align: center;" {th_style}>CANTIDAD</th>
