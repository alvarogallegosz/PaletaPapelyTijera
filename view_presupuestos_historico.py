...
def render_tarjeta_presupuesto(p: dict, rol_actual: str = "administrador", idx="0"):
    ...
    with st.expander(titulo_tarjeta, expanded=False):
        ...
        with col_info3:
            ...
            # ✅ FIX: idx agregado a la key y uso explícito de options=
        ...
        with b_col3:
            ...
            if st.button(
                txt_plantilla, key=f"btn_plantilla_{id_p}_{idx}", use_container_width=True
            ):
        ...
        with b_col4:
            # ✅ FIX: idx agregado a la key
            if st.button(
                "🗑️ Eliminar", key=f"btn_del_{id_p}_{idx}", use_container_width=True
            ):
...
def render_historico_presupuestos(rol_actual: str = "administrador"):
    ...
    with tab_historico:
        ...
        with f_col2:
            ...
            filtro_tipo = st.selectbox(
                "Filtrar por Tipo:", options=tipos_disp, key="filter_tipo"
            )
        ...
        # ✅ FIX: Bucle modificado para iterar sobre la lista filtrada y pasar el 'idx' con prefijo
    ...
    with tab_plantillas:
        ...
        if not plantillas:
            ...
            # ✅ FIX: Bucle modificado para usar enumerate y pasar el 'idx' con prefijo
